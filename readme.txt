...
- Fixed:
Product loop duplicated content in editor mode.
...
= 2.9.12 - January 08, 2024 =
- Fixed:
Product tabs widget grid layout.

= 2.9.11 - December 25, 2023 =
- Fixed:
Fix items per view setting of Elementor carousel widgets not working properly on mobile.
Fix PHP warning on single product.
Removed lazy loading for site logo.
